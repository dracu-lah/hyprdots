...
# wf-recorder -g "$(slurp)" -a "alsa_input.pci-0000_00_1f.3.analog-stereo.monitor" -f "$HOME/Videos/hyprland_recording_${dateTime}.mp4" &
wf-recorder -a "alsa_input.pci-0000_00_1f.3.analog-stereo.monitor" -f "$HOME/Videos/hyprland_recording_${dateTime}.mp4" &
